  ...
  return (
    <section className={style.home_teacher_rec}>
      ...
      <div className={style.home_teacher_rec_templates}>
        ...
        <p>
          Карта з локаціями виконана грамотно: інтерфейс зручний, розміщення
          об'єктів логічне. Вона добре підтримує навчальний процес і дозволяє
          швидко орієнтуватися в завданнях.
        </p>
      </div>
    </section>
  );
